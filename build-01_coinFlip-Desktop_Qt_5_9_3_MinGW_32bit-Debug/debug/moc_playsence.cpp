...
#include "../../01_coinFlip/playsence.h"
...
QT_MOC_LITERAL(1, 10, 21), // "showSecletLevelWindow"
QT_MOC_LITERAL(2, 32, 0) // ""

    },
    "PlaySence\0showSecletLevelWindow\0"
};
...
void PlaySence::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->showSecletLevelWindow(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&PlaySence::showSecletLevelWindow)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject PlaySence::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PlaySence.data,
      qt_meta_data_PlaySence,  qt_static_metacall, nullptr, nullptr}
};
...
// SIGNAL 0
void PlaySence::showSecletLevelWindow()
{
